		...
		<form id="frm" action="memberLogin.do" method="post">
			<div align="center">
				<table>
					...
					<th width="100">아이디</th>
					<th width="300">
						<input type="email" class="form-control form-control-lg" id="id" name="id" placeholder="email을 입력하세요.." required="required" />
					</th>
					</tr>
					<tr class="form-group">
					<th width="100">패스워드</th>
					<th width="300">
						<input type="password" class="form-control form-control-lg" id="password" name="password" placeholder="password를 입력하세요.." required="required" />
					</th>
					</tr>
				</table>
			</div><br>
			<div>
				...
				<input type="reset" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="취 소 ">
			</div>
		</form>
	</div>
</div>
