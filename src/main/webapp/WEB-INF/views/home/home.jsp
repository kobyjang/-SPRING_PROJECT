    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0" align="center">*보유 기술서<br>JAVA, JSP, SPRING, REACT<br>이메일<br>java.koby@gmail.com</p>
            </div>
        </header>
        <!-- Portfolio Section-->
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        ...
                        <div align="center"><h1>JSP 프로젝트</h1></div>
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        ...
                        <div align="center"><h1>SPRING 프로젝트</h1></div>
                    </div>
                    <!-- Portfolio Item 3-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        ...
                        <div align="center"><h1>REACT 프로젝트</h1></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row">
                    <p class="lead" align="center">학원에 다니는 6개월 동안 웹 개발 중 어떻게 하면 더 잘할 수 있을까 고민도 많이 하면서 열심히 여기까지 왔습니다.
													...
													좀 더 정교하고 잘하는 IT 개발자가 되고 싶습니다. 감사합니다.</p></div>
                     </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <img class="img-fluid rounded mb-5" src="./resources/assets/img/portfolio/JSP.jpg" alt="..." />
                    ...
                    <div class="modal-body text-center pb-5">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <!-- Portfolio Modal - Title-->
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">SPRING 프로젝트</h2>
                                    <!-- Icon Divider-->
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="./resources/assets/img/portfolio/Spring.jpg" alt="..." />
                                    <!-- Portfolio Modal - Text-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="./resources/assets/img/portfolio/React.jpg" alt="..." />
                                    <!-- Portfolio Modal - Text-->
