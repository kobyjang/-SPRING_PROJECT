    ...
    <body id="page-top">
	    ...
	    <header class="masthead1 text-center">
	            <div class="container" align="center">
					...
					<div><button type="button" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" onclick="location.href='noticeList.do'">게시판으로 가기</button></div>
				</div>
		</header>
        <!-- Footer-->
