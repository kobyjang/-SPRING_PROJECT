...
<div><h1>공지사항 목록</h1>	</div>
	<div>
		<form id="frm">
			...
			<input type="button" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="검색" onclick="BoardSearch()">
		</form>
	</div><br>
	<div>
	...
	<div>
		<c:if test="${id != null }">
			<button type="button"  class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" onclick="location.href='boardForm.do'">글쓰기</button>
		</c:if>
	</div>
	<div>
